...
#ifndef NATIVE_WITH_STATE_INTERNAL_CONFERENCE_PEER_CONNECTION_H_
#define NATIVE_WITH_STATE_INTERNAL_CONFERENCE_PEER_CONNECTION_H_
...
#endif  // NATIVE_WITH_STATE_INTERNAL_CONFERENCE_PEER_CONNECTION_H_
