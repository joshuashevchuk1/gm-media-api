...
#ifndef NATIVE_WITH_STATE_INTERNAL_RESOURCE_HANDLER_INTERFACE_H_
#define NATIVE_WITH_STATE_INTERNAL_RESOURCE_HANDLER_INTERFACE_H_
...
#endif  // NATIVE_WITH_STATE_INTERNAL_RESOURCE_HANDLER_INTERFACE_H_
