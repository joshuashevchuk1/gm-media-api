...
#ifndef NATIVE_WITH_STATE_INTERNAL_MEDIA_ENTRIES_RESOURCE_HANDLER_H_
#define NATIVE_WITH_STATE_INTERNAL_MEDIA_ENTRIES_RESOURCE_HANDLER_H_
...
#endif  // NATIVE_WITH_STATE_INTERNAL_MEDIA_ENTRIES_RESOURCE_HANDLER_H_
