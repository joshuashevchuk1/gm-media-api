...
#ifndef NATIVE_WITH_STATE_INTERNAL_TESTING_MOCK_CURL_API_WRAPPER_H_
#define NATIVE_WITH_STATE_INTERNAL_TESTING_MOCK_CURL_API_WRAPPER_H_
...
#endif  // NATIVE_WITH_STATE_INTERNAL_TESTING_MOCK_CURL_API_WRAPPER_H_
