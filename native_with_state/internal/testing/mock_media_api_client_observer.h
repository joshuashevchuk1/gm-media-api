...
#ifndef NATIVE_WITH_STATE_INTERNAL_TESTING_MOCK_MEDIA_API_CLIENT_OBSERVER_H_
#define NATIVE_WITH_STATE_INTERNAL_TESTING_MOCK_MEDIA_API_CLIENT_OBSERVER_H_
...
#endif  // NATIVE_WITH_STATE_INTERNAL_TESTING_MOCK_MEDIA_API_CLIENT_OBSERVER_H_
