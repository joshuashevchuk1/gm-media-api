...
#ifndef NATIVE_WITH_STATE_INTERNAL_STATS_REQUEST_FROM_REPORT_H_
#define NATIVE_WITH_STATE_INTERNAL_STATS_REQUEST_FROM_REPORT_H_
...
#endif  // NATIVE_WITH_STATE_INTERNAL_STATS_REQUEST_FROM_REPORT_H_
