...
#ifndef NATIVE_WITH_STATE_INTERNAL_CONFERENCE_MEDIA_TRACKS_H_
#define NATIVE_WITH_STATE_INTERNAL_CONFERENCE_MEDIA_TRACKS_H_
...
#endif  // NATIVE_WITH_STATE_INTERNAL_CONFERENCE_MEDIA_TRACKS_H_
