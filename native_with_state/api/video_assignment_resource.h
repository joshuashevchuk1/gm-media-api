...
#ifndef NATIVE_WITH_STATE_API_VIDEO_ASSIGNMENT_RESOURCE_H_
#define NATIVE_WITH_STATE_API_VIDEO_ASSIGNMENT_RESOURCE_H_
...
#endif  // NATIVE_WITH_STATE_API_VIDEO_ASSIGNMENT_RESOURCE_H_
