...
#ifndef NATIVE_WITH_STATE_API_PARTICIPANTS_RESOURCE_H_
#define NATIVE_WITH_STATE_API_PARTICIPANTS_RESOURCE_H_
...
// Phone user, always has a display name. User dialing in from a phone where the
// user's identity is unknown because they haven't signed in with a Google
// Account.
struct PhoneUser {
...
struct Participant {
  ...
  // same conference. Unused for now.
...
#endif  // NATIVE_WITH_STATE_API_PARTICIPANTS_RESOURCE_H_
