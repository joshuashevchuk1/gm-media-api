...
#ifndef NATIVE_WITH_STATE_API_MEDIA_STATS_RESOURCE_H_
#define NATIVE_WITH_STATE_API_MEDIA_STATS_RESOURCE_H_
...
#endif  // NATIVE_WITH_STATE_API_MEDIA_STATS_RESOURCE_H_
