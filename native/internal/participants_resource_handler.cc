...
absl::StatusOr<ParticipantsChannelToClient>
ParticipantsResourceHandler::ParseUpdate(absl::string_view update) {
  DLOG(INFO) << kParticipantsResourceName
  ...
  ParticipantsChannelToClient resource_update;
  // Resources
