...
#ifndef NATIVE_INTERNAL_TESTING_MOCK_CURL_API_WRAPPER_H_
#define NATIVE_INTERNAL_TESTING_MOCK_CURL_API_WRAPPER_H_
...
class MockCurlApiWrapper : public CurlApiWrapper {
 public:
  MockCurlApiWrapper() {
    ...
    ON_CALL(*this, EasySetOptPtr).WillByDefault(Return(CURLcode::CURLE_OK));
...
#endif  // NATIVE_INTERNAL_TESTING_MOCK_CURL_API_WRAPPER_H_
