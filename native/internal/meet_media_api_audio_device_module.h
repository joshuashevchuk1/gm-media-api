...
#ifndef NATIVE_INTERNAL_MEET_MEDIA_API_AUDIO_DEVICE_MODULE_H_
#define NATIVE_INTERNAL_MEET_MEDIA_API_AUDIO_DEVICE_MODULE_H_
...
class MeetMediaApiAudioDeviceModule
    : public webrtc::webrtc_impl::AudioDeviceModuleDefault<
          webrtc::AudioDeviceModule> {
 public:
  MeetMediaApiAudioDeviceModule() = default;

  ~MeetMediaApiAudioDeviceModule() override { StopPlayout(); };
...
#endif  // NATIVE_INTERNAL_MEET_MEDIA_API_AUDIO_DEVICE_MODULE_H_
